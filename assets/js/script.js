...
<div class="card">
  <div style="margin-top: 30px;">
    ...
    <div class="download-grid">
      <a href="https://github.com/Projec-tf/crisutf-tv/releases/download/v2.1.0/crisutf.tv-mobile.apk" class="download-btn"><span class="download-icon"><img src="/media/icons/mobile.svg" alt="Mobile" class="svg-icon-small"/></span><span class="download-text"><strong>Android (V2.1)</strong><small>Para teléfonos y tablets</small></span></a>
      <a href="https://github.com/Projec-tf/crisutf-tv/releases/download/v2.1.0/crisutf.tv-tv.apk" class="download-btn"><span class="download-icon"><img src="/media/icons/tv.svg" alt="TV" class="svg-icon-small"/></span><span class="download-text"><strong>Android TV (V2.1)</strong><small>Para Smart TV y TV Box</small></span></a>
      <a href="https://github.com/Projec-tf/crisutf-tv/releases/download/v2.1.0/crisutf.tv-pc.exe" class="download-btn"><span class="download-icon"><img src="/media/icons/computer.svg" alt="Computer" class="svg-icon-small"/></span><span class="download-text"><strong>Windows (V2.1)</strong><small>Para computadoras</small></span></a>
